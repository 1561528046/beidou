    ...
    <el-row :gutter="30">
      <el-col :span="24">
        <el-form-item label="标注" prop="device_no">
          <el-input v-model="formData.device_no" placeholder="标注"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="24">
        <el-form-item label="IP" prop="sim_id">
          <el-input v-model="formData.sim_id" maxlength="14" placeholder="IP"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="24">
        <el-form-item label="端口号" prop="company_id">
          <el-input v-model="formData.sim_id" maxlength="14" placeholder="端口号"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="24">
