  ...
  <div class="admin-table-container">
    <el-card shadow="always">
      ...
      <el-table :data="tableData.data" v-loading="tableLoading" style="width: 100%" class="admin-table-list">
        ...
        <el-table-column prop="" label="远程IP"></el-table-column>
        <el-table-column prop="" label="远程端口"></el-table-column>
        <el-table-column prop="" label="用户ID"></el-table-column>
        <el-table-column prop="" label="密码"></el-table-column>
        <el-table-column prop="" label="本地端口"></el-table-column>
        <el-table-column prop="" label="M1"></el-table-column>
        <el-table-column prop="" label="IA1"></el-table-column>
        <el-table-column prop="" label="IC1"></el-table-column>
        <el-table-column prop="" label="接入码"></el-table-column>
        <el-table-column prop="" label="Keys"></el-table-column>
    ...
    <el-dialog title="添加" width="35%" :visible.sync="addDialog" :append-to-body="true" :close-on-click-modal="false" :close-on-press-escape="false" :center="true" class="admin-dialog">
