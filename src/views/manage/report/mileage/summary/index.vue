  ...
  <div class="admin-table-container">
    ...
    <el-card shadow="always">
      <el-table :data="list" v-loading="tableLoading" style="width: 100%" class="admin-table-list">
        ...
        <el-table-column prop="" label="行驶里程"> </el-table-column>
        ...
        <el-table-column prop="" label="开始里程" :formatter="(row)=>{return this.$utils.formatDate14(JSON.stringify(row.time))}"> </el-table-column>
        ...
        <el-table-column prop="" label="结束里程" :formatter="$utils.baseFormatter "> </el-table-column>
