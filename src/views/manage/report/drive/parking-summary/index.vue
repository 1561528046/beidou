  ...
  <div class="admin-table-container">
    ...
    <el-card shadow="always">
      <el-table :data="list" v-loading="tableLoading" style="width: 100%" class="admin-table-list">
        ...
        <el-table-column prop="" label="停车次数" :formatter="$utils.baseFormatter "> </el-table-column>
        <el-table-column prop="" label="停车总时长" :formatter="$utils.baseFormatter "> </el-table-column>
      </el-table>
