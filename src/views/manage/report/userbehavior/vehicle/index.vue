  ...
  <div class="admin-table-container">
    ...
    <el-card shadow="always">
      <el-table :data="list" v-loading="tableLoading" style="width: 100%" class="admin-table-list">
        ...
        <el-table-column prop="" label="设备号"> </el-table-column>
        <el-table-column prop="" label="变更内容" :formatter="$utils.baseFormatter "> </el-table-column>
        <el-table-column prop="" label="变更时间" :formatter="$utils.baseFormatter "> </el-table-column>
        <el-table-column prop="" label="变更人" :formatter="$utils.baseFormatter "> </el-table-column>
