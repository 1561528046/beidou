<template>
  <div class="admin-table-container">
        ...
        <el-table-column width="400" label="操作">
          <template slot-scope="scope">
            <el-button
              ...
              @click="confirm(scope)"
              v-if="scope.row.state=='1'&&scope.row.has_review=='2'"
              v-rights="3-4-1"
            >确认开通</el-button>
            <el-button
              size="small "
              ...
              @click="review(scope)"
              v-if="scope.row.state=='5'&&scope.row.has_review=='2'"
              v-rights="3-4-3"
            >审核</el-button>
            <el-button
              size="small "
              ...
              v-if="scope.row.fees_detail_name=='开通'"
              @click="enquiry(scope)"
            >查看资料</el-button>
            <el-dialog
              width="30%"
    ...
    >
      <order-data
        :order_no="order_no"
        @success=" ()=> {this.getTable();this.lookDialog = false;}"
        :key="addKey"
      ></order-data>
    </el-dialog>
  </div>
