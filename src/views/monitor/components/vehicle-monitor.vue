<template>
  <div class="vehicle-info-container" :class="{'single':$props.single}" :style="{left:position.left+'px',top:position.top+'px'}">
    ...
    <div class="vehicle-additional-alarm" style="position:absolute;left:370px;">
      <div class="shadow-box" style="background:#FFF;width:350px; font-size:12px;margin-bottom:20px;" v-if="mapData.vehicle.additional0X64">
    ...
    <div class="vehicle-info-box shadow-box" ref="box">
      ...
      <div class="_body">
        <el-row>
          ...
          <el-col v-if="mapData.vehicle.overSpeedPositionType!==0" :span="12">区域或路段ID：{{mapData.vehicle.overSpeedAreaId||"--"}}</el-col>
        ...
        <el-row>
          ...
          <el-col :span="24" v-if="mapData.vehicle.fence_alarm&&mapData.vehicle.fence_alarm.alarmList&&mapData.vehicle.fence_alarm.alarmList.length">
            ...
            <span v-for="key in mapData.vehicle.fence_alarm.alarmList" :key="key">
              <span v-for="fenceItem in mapData.vehicle.fence_alarm[key]" :key="fenceItem.RegionId">&#x3000;{{getFenceAlarmType(fenceItem)}} {{fenceItem.RegionName}}</span>
            </span>
          </el-col>
