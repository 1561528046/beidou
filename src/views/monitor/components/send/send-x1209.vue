      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="时间：">
            <el-date-picker style="width:90%" size="small" value-format="yyyy-MM-dd HH:mm:ss" v-model="time" type="datetimerange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期">
            </el-date-picker>
          </el-form-item>
        </el-col>
        <el-col :span="8">
