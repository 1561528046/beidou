    ...
    <el-tabs v-model="currentTab" type="border-card" @tab-click="smallSize = false">
      ...
      <el-tab-pane :closable="false" name="x0301">
        <span slot="label"> 事件报告
          <el-badge :value="$store.getters['x0301/list'].length" :max="99" class="monitor-badge"> </el-badge>
        </span>
      ...
      <el-tab-pane :closable="false" name="list809">
        <span slot="label"> 查岗
          <el-badge :value="$store.getters['x809/list'].length" :max="99" class="monitor-badge"> </el-badge>
        </span>
        <list809></list809>
      </el-tab-pane>
